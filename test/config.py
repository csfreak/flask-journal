...
html_test_strings = {
    ...
    "settings": {
        ...
        "css": {
            "default": (
                '<link rel="stylesheet"'
                ' href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">'  # noqa: B950
            ),
            "bootswatch": (
                '<link rel="stylesheet"'
                ' href="https://cdn.jsdelivr.net/npm/bootswatch@5.3.0/dist/%s/bootstrap.min.css">'  # noqa: B950
            ),
        },
    },
}
