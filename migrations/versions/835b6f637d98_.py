...
def upgrade():
    ...
    op.create_table('user',
                    ...
                    sa.Column('current_login_ip', sa.String(
                        length=100), nullable=True),
                    ...
                    sa.UniqueConstraint(
                        'fs_uniquifier', name=op.f('uq_user_fs_uniquifier'))
                    )
    ...
    op.create_table('user_settings',
                    sa.Column('user_id', sa.Integer(), nullable=False),
                    sa.Column('encrypt_entries', sa.Boolean(), nullable=False),
                    ...
                    sa.Column('deleted_at', sa.DateTime(
                        timezone=True), nullable=True),
                    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f(
                        'fk_user_settings_user_id_user')),
                    sa.PrimaryKeyConstraint(
                        'id', name=op.f('pk_user_settings'))
                    )
    op.create_table('entry_tags',
                    ...
                    sa.Column('deleted_at', sa.DateTime(
                        timezone=True), nullable=True),
                    sa.ForeignKeyConstraint(['entry_id'], ['entry.id'], name=op.f(
                        'fk_entry_tags_entry_id_entry')),
                    sa.ForeignKeyConstraint(['tag_id'], ['tag.id'],
                                            name=op.f('fk_entry_tags_tag_id_tag')),
                    sa.PrimaryKeyConstraint('id', name=op.f('pk_entry_tags')),
                    sa.UniqueConstraint('entry_id', 'tag_id',
                                        name=op.f('uq_entry_tags_entry_id'))
                    )
